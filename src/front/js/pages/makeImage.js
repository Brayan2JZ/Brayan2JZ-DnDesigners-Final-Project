...
const StatForm = () => {
  ...
  return (
    <div className='form'>
      ...
      <label for="bubbleRange" className="form-label formTitle  text-light">How many stat bubbles do you need? {store.bubbleRange}</label>
      ...
      <div className="input-group statToAdd d-flex">
        ...
        <div class="mb-3">
          ...
          <div className="btn-group" role="group" aria-label="Basic example" >
            <button type="button" className="btn btn-warning mx-1 formTitle" onClick={() => actions.setFormInput({ ...formInput, damage: formInput.statToAdd })}>Damage</button>
            <button type="button" className="btn btn-warning mx-1 formTitle" onClick={() => actions.setFormInput({ ...formInput, spell: formInput.statToAdd })}>Spell/Effect</button>
            <button type="button" className="btn btn-warning mx-1 formTitle" onClick={() => actions.setFormInput({ ...formInput, description: formInput.statToAdd })}>Description</button>
          </div>

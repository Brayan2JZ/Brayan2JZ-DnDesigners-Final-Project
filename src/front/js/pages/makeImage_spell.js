...
const StatForm = () => {
  ...
  return (
    <div className='form formTitle'>
      ...
      <label for="bubbleRange" class="form-label text-light">How many stat bubbles do you need? {store.bubbleRange}</label>
      ...
      <div className="input-group statToAdd d-flex">
        ...
        <div class="mb-3">
          ...
          <div class="btn-group" role="group" aria-label="Basic example" >
            <button type="button" class="btn btn-danger mx-1" onClick={() => actions.setFormInputSpell({ ...formInputSpell, damage: "Damage: " + formInputSpell.statToAdd })}>Damage</button>
            <button type="button" class="btn btn-danger mx-1" onClick={() => actions.setFormInputSpell({ ...formInputSpell, components: "Components needed: " + formInputSpell.statToAdd })}>Components</button>
            <button type="button" class="btn btn-danger mx-1" onClick={() => actions.setFormInputSpell({ ...formInputSpell, higherLvl: "At higher levels: " + formInputSpell.statToAdd })}>Higher Lvl</button>
